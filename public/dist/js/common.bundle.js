...
var _nojs = __webpack_require__(2);

var _nojs2 = _interopRequireDefault(_nojs);
...
var _globalnavbtn = __webpack_require__(5);

var _globalnavbtn2 = _interopRequireDefault(_globalnavbtn);

var _anchor = __webpack_require__(6);

var _anchor2 = _interopRequireDefault(_anchor);

var _animatecss = __webpack_require__(7);
...
// Mini Boo JS
(0, _nojs2.default)('html');
(0, _loader2.default)('#loader');
(0, _anchor2.default)('a[href^="#"]');
(0, _scrolltop2.default)('#scrollTop');
(0, _globalnavbtn2.default)('#navbar_toggler');
(0, _animatecss2.default)('.js-animate');
...
var Nojs = function Nojs(target) {

  var _tar = document.getElementsByTagName(target);
  _tar[0].classList.remove('no-js');
};
...
var Loader = function Loader(target) {
...
var ScrollTop = function ScrollTop(target) {

  document.addEventListener('DOMContentLoaded', function () {

    var replace = target.slice(1);
    var _tar = document.getElementById(replace);
    var event = ['isActive', 'isNoActive'];

    function scrollEvent() {
      var value = document.documentElement.scrollTop || document.body.scrollTop;
      var checkActive = _tar.classList.contains(event[0]);
      var checkNoActive = _tar.classList.contains(event[1]);
      if (value > 400) {
        if (checkNoActive) {
...
// グローバルナビボタン
// ========================================================
var GlobalNavBtn = function GlobalNavBtn(target) {

  document.addEventListener('DOMContentLoaded', function () {

    var replace = target.slice(1);
    var _tar = document.getElementById(replace);
    var event = ['isOpened', 'isClosed'];

    function btnEvent() {
      var checkOpened = this.classList.contains(event[0]);
      var checkClosed = this.classList.contains(event[1]);
      if (checkOpened) {
...
var Anchor = function Anchor(target) {
  ...
  (0, _jquery2.default)(function () {
    // console.log(TARGET);
    // console.log($(TARGET));
    (0, _jquery2.default)(tar).on('click', function () {
...
var AnimateCss = function AnimateCss(tar) {
  ...
  function animate(tar) {
    (0, _jquery2.default)(tar).each(function () {
      var _tar = (0, _jquery2.default)(this);
  ...
  (0, _jquery2.default)(window).on('touchstart scroll', function () {
    setTimeout(function () {
      animate(TARGET);
    }, 100);
  });
